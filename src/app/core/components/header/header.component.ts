...
export class HeaderComponent implements OnInit {
  ...
  constructor(private _route: Router, private _jsxInjectorService: JsxInjectorService, private _userManagerService: UserManagerService,
  ...
  handleNavigationChange(): void {
    this._route.events.subscribe((event) => {
      if (this._route.url.match(/\/setting\/*/i)) {
 ...
 */
  linkedToJoinUs(): void {
    this._jsxInjectorService.openUrlInBrowser('https://pixflowstudio.typeform.com/to/qEWoKt');
  }
